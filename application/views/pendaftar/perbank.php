  ...
  <body>
     <div class="container post">
      <div class="card-header">
                <h3 class="card-title">JURUSAN PERBANKAN</h3>
            </div>
          <div class="row">
            <?php 
              foreach($data_perbank as $key => $value){
                echo "<div class='col-md-4'>
              <div class='card mb-4 box-shadow'>
                <img class='card-img-top' src='".base_url('upload/perbank/').$value->logo_perbank."' alt='Card image cap' width='600px' height='400px'>
                <div class='card-body'>
                  <p class='card-text'>Jurusan $value->nama_perbank</p>
                  <p class='card-text'>Jumlah Siswa $value->jml_siswa_perbank</p>
                  <p class='card-text'>Motto Jurusan $value->motto_perbank</p>
                  <p class='card-text'>Acara $value->acara_perbank</p>
                  <p class='card-text'>By $value->ketua_perbank</p>
