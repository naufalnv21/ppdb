        ...
        <div class="row mb-2">
          ...
          foreach ($data_perbank as $perbank) {
            ...
            <tr>
              ...
              <td><?php echo anchor('operator/O_perbank/edit/'.$perbank->id_perbank,'<div class="btn btn-primary btn-sm" ><i class="fa fa-edit"></i></div>')?></td>
              <td onclick="javascript: return confirm('Anda yakin hapus?')"><?php echo anchor('operator/O_perbank/hapus/'.$perbank->id_perbank, '<div class="btn btn-danger btn-sm" ><i class="fa fa-trash"></i></div>' ) ?>
              </td>
            </tr>
          <?php } ?> 
        </table>
