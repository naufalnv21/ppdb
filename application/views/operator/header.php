...
<head>
  ...
  <title>SMK RISTEK | Dashboard</title>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo base_url('assets/template/back/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/template/back/plugins/datatables-responsive/css/responsive.bootstrap4.min.css'); ?>">
  <!-- Theme style -->
